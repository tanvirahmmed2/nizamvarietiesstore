...
const SingleProduct = async ({ params }) => {
  ...
  return (
    <div className='w-full max-w-6xl mx-auto min-h-screen flex flex-col gap-20 items-center justify-center  rounded-2xl'>
      <div className='w-full flex flex-col lg:flex-row gap-8 bg-white m-6 p-2 md:p-4 rounded-2xl shadow-sm border border-slate-100'>
