        ...
        <div className='flex-1 p-4 bg-white rounded-xl'>
            ...
            <div className='flex flex-col gap-3'>
                {purchases.length > 0 ? purchases.map((item) => (
                    <div key={item.purchase_id} className='flex items-center justify-between p-4 border border-sky-100 rounded-lg hover:bg-sky-50 transition-all'>
                ...
                )) : <p className='text-center text-gray-400 py-10'>No purchase records found</p>}
            </div>
        </div>
    )
}
