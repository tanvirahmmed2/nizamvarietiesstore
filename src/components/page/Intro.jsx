    ...
    return (
        <div className=' w-full flex flex-col gap-8'>
            ...
            <div className='w-full h-150 overflow-hidden flex items-center justify-center relative'>
                <Image src={`/bg.jpg`} className='w-full h-150 object-cover blur-[8px] opacity-90' alt='home image' width={1000} height={1000} />
                <div className="absolute inset-0 sm:gap-4 flex flex-col items-center justify-center text-white bg-black/10 p-4">
                    ...
                    <p className='font-semibold font-serif text-center max-w-3xl'>Quality meets convenience. We bridge the gap between your daily needs and modern tech. From essential personal care and professional phone recharge services to high-quality electronics and fresh bakery items, we provide a seamless shopping experience for our local community. One basket, endless possibilities</p>
                </div>
            </div>
