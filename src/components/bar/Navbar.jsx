...
const Navbar = () => {
  ...
  return (
    <div className='w-full relative'>
      <nav className='w-full flex flex-row items-center justify-between fixed top-0 right-0 h-14 px-4 bg-sky-500 text-white z-50'>
        <Link href={'/'} className='text-lg sm:text-2xl font-semibold uppercase'>Nizam Varieties Store</Link>
        ...
        <div className='w-auto flex flex-row items-center justify-center gap-4'>
          ...
          <div className='w-auto hidden sm:flex flex-row items-center justify-center gap-2'>
            ...
            <Link className='px-4 h-10 bg-orange-400 rounded-2xl w-auto flex items-center justify-center hover:bg-red-400' href={'/login'}>Login</Link>
          </div>
        </div>
